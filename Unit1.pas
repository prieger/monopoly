...
uses
  ...
  Dialogs,umonopoly, StdCtrls,ScktComp,unetzwerk,ShellApi,WinSock;
...
label1.Caption:='Eigene IP: '+LocalIP;
end;
...
if s='read brett' then
  Begin
  OpenDialog1.execute;
  if opendialog1.FileName<>'' then monop.einlesen(opendialog1.FileName);
  ende:=true;
  end;
